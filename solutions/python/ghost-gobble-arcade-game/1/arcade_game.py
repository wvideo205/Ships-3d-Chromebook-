...
def lose(power_pellet_active, touching_ghost):
    ...
    """
    losing = touching_ghost and not power_pellet_active
    return losing 
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    winning = has_eaten_all_dots and power_pellet_active and touching_ghost or has_eaten_all_dots and not touching_ghost
